...
public class GridBlock {
	...
	public AtomicInteger isOccupied = new AtomicInteger();

	public final AtomicBoolean isStart = new AtomicBoolean();  //is this a starting block?
	public int [] coords; // the coordinate of the block.
